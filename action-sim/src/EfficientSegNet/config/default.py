...
_C.TEST.MODEL_FILE = '/home/justin/Desktop/neff-dev/weights/EfficientHRSeg-H0/EfficientHRSeg-H0.pth' #'/home/aneri/seg_B0/output_B0_v2_hrnet_ohem/cityscapes/B0/best.pth'
...
def seg_update_config(seg_cfg, args):
    seg_cfg.defrost()
    
    seg_cfg.merge_from_file(args.seg_cfg)
    seg_cfg.merge_from_list(args.opts)
