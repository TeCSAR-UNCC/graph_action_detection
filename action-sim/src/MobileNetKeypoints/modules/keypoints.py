...
def extract_keypoints(heatmap, all_keypoints, total_keypoint_num):
    ...
    #print(type(heatmap)) - numpy.ndarray
    ...
    for i in range(len(keypoints)):
        ...
        #print(type(keypoint_with_score_and_id)) - tuple
        #print(type(total_keypoint_num)) - int
        #print(type(keypoint_num)) #- int
        keypoint_num += 1
    all_keypoints.append(keypoints_with_score_and_id)
    #print(type(all_keypoints)) - list
    #print(type(keypoints_with_score_and_id)) - list
    return keypoint_num


def group_keypoints(all_keypoints_by_type, pafs, pose_entry_size=20, min_paf_score=0.05, demo=False):
    pose_entries = []
    #print(type(pose_entries)) - list 
    all_keypoints = np.array([item for sublist in all_keypoints_by_type for item in sublist])
    #print(type(all_keypoints)) -'numpy.ndarray'
    #print(type(pose_entry_size)) -int 
    #print(type(all_keypoints_by_type)) - list (1d list) 
    for part_id in range(len(BODY_PARTS_PAF_IDS)):
       #print(type(part_id)) -int 
        part_pafs = pafs[:, :, BODY_PARTS_PAF_IDS[part_id]]
       #print(type(part_pafs)) -numpy.ndarray
        kpts_a = all_keypoints_by_type[BODY_PARTS_KPT_IDS[part_id][0]]
        #print(type(kpts_a))-list 
        kpts_b = all_keypoints_by_type[BODY_PARTS_KPT_IDS[part_id][1]]
        #print("kpts_b")
        #print(type(kpts_b)) -list
        num_kpts_a = len(kpts_a)
        #print("num_kpts_a")
        #print(type(num_kpts_a)) -int
        num_kpts_b = len(kpts_b)
        #print("num_kpts_b")
        #print(type(num_kpts_b))  -int
        kpt_a_id = BODY_PARTS_KPT_IDS[part_id][0]
       #print("kpt_a_id") 
        #print(type(kpt_a_id)) - int 
        kpt_b_id = BODY_PARTS_KPT_IDS[part_id][1]
        #print("kpt_b_id") 
        #print(type(kpt_b_id)) -int 
